              ...
              <div class="panel-body">
                  <table class="table kurssintentit" align="center">
                    <c:forEach var="tentti" items="${t:sortByDate(kurssi.kurssinTentit)}">
                        <tr>
                            <td>${tentti.tyyppi}</td><td>${tentti.pitaja}</td><td>${tentti.kieli.lyhenne}</td><td><strong>${tentti.pvm}</strong></td><td><a href="${tentti.fileURL}"><div class="glyphicon glyphicon-download"></div></a></td><td><a href="/tentit/${tentti.id}">Tentin tiedot</a></td>
                        </tr>
                    </c:forEach>
                  </table>
              </div>
